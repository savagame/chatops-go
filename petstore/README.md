...
You have seen an example application that did metrics and tracing using Open Telemetry (OTEL). This application was designed to be simple and easy to understand.
...
Here is a breakdown of how the petstore application is made. This is not required for but looking at the code will give you a deeper insight into how you might want to structure a real application.
...
Of note:
_ The log package outputs log messages to a tracing Span, not to a log file
_ If you do need to output some startup info, log.Logger is the standard log.Logger type, defaults to the default Logger
_ The errors package is a drop in replacement for "log", except Errorf() and New() take a Context
_ errors will write the error out to the current Span
